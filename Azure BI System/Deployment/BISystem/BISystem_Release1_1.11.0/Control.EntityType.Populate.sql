...
USING 
	(VALUES
	  ...
	  --[EI],	[PETI],	[AI],	[IS],	[HMS],	[Name],										[Code],									[Description],													[Schema],				[Table],									[CreatedBy]							[CreatedDate]
		...
		(704,	NULL,	9,   	0,	    0,      N'BITstaging.StagedType5',					N'BITstaging.StagedType5',				N'BITurquoise Distribution File Moved Landing to Staging',      N'BITstaging',        	N'BITstaging.StagedType5',					N'tim.firmin@prsformusic.com',  SYSDATETIME()),
