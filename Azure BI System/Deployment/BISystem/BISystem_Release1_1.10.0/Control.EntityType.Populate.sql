...
USING 
	(VALUES
	  ...
	  --[EI],	[PETI],	[AI],	[IS],	[HMS],	[Name],										[Code],									[Description],													[Schema],				[Table],									[CreatedBy]							[CreatedDate]
		...
		(608,	NULL,	12,		1,		0,		N'LicensingBodies',							N'DM_LICENSINGBODIES',					N'Oracle LICENSING_BODIES table',								N'DMOWN',				N'DM_LICENSING_BODIES',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
