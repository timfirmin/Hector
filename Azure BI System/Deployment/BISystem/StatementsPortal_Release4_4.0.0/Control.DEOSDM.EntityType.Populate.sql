...
USING 
	(VALUES
	  --[EI],	[PETI],	[AI],	[IS],	[HMS],	[Name],										[Code],									[Description],													[Schema],				[Table],									[CreatedBy]							[CreatedDate]
		(2001,	NULL,	16,		1,		0,		N'Address',									N'dmsaddress',							N'Address Table',												N'DMOWN',				N'DMS_ADDRESS',								N'Jonathan.Myers@prsformusic.com',	SYSDATETIME()),
...
--		(2026,	NULL,	16,		1,		0,		N'DistributionLoadControl',					N'dmsdistributionloadcontrol',			N'DMS Distribution Load Control table',							N'DMOWN',				N'DMS_DISTRIBUTION_LOAD_CONTROL',			N'Jonathan.Myers@prsformusic.com',	SYSDATETIME()),
...
--		(2138,	NULL,	16,		1,		0,		N'ReportTypes',								N'dmsreporttypes',						N'DMS Report Types',											N'DMOWN',				N'DMS_REPORT_TYPES',						N'Jonathan.Myers@prsformusic.com',	SYSDATETIME()),
		...
		(2130,	NULL,	16,		0,		0,		N'DimWorkAttributes',						N'dimWorkAttributes',					N'Online Statements Dim Work Attributes',						N'Warehouse',			N'DimWorkAttributes',						N'Jonathan.Myers@prsformusic.com',	SYSDATETIME()),
