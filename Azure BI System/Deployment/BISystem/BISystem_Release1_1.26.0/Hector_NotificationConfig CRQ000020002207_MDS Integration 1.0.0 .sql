...
,('MDS Master Station Validation' ,'HTMLEMAIL' ,1 , 'AZI-MS-SQL-P001 SQL Database Mail', '<BR>' , '<html>  <head>    <style> body {  background-color: #D8D8D8;}table {    width:500;    font-family:"Segoe UI";   align="center";  }table, th, td {    border: 1px solid black;    border-collapse: collapse;}th, td {    padding: 25px;}</style>  </head>  <!-- <h2><font face="Segoe UI"> Email content</font></h2>--><br>  <table id="t01">    <tr>      <!-- <th align="left"><p><font face="Comic sans MS" color="green">PRS Master Data Management</font></p></th>-->          <th align="left"  bgcolor="white" >        <h3>PRS Master Data Management</h3>      </th>      <!--https://www.prsformusic.com/press/2018/record-royalties-paid-to-songwriters-and-composers--><!--Other email content-->    </p>    </tr>    <tr>      <td align="center" bgcolor="black" style="color: white;">        <p>        <h3>MDS Master Station Validation Report #Date#</h3>		<br>#ValidationBreaks# Master station(s) break validation rules.</br>      </td>    </tr>    <tr>      <td align="center"  bgcolor="white" >Full details can be found by following the report link below<br><a href=#ReportLink#>MDS Master Station Validation Report</a></br> <br>In accordance with the agreed data governance process, please review the above changes and ensure all updates are made.</br>     </tr>  </table>  </body></html>', '<BR> Regards, <BR> PRS BI Team')
...
from (values ('MDS Station Changes','#NewREP#','NNewREP',1)
			...
			,('MDS Master Station Validation' , '#ValidationBreaks#' , 'NValidationBreaks' , 1 )
...
from (values('MDS Station Changes','Tony Wilkinson')
			...
			,('MDS Master Station Validatione','Tim Firmin')
