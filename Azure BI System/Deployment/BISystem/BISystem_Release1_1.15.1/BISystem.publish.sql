/* Deploying: Control.Application.Populate.sql */
PRINT 'Deploying: Control.Application.Populate.sql'
GO
...
/* Deploying: Control.SourceFile.Populate.sql */
PRINT 'Deploying: Control.SourceFile.Populate.sql'
GO
...
/* Deploying: ChartMartControl.sql */
PRINT 'Deploying: ChartMartControl.sql'
...
/* Deploying: ChartMartControl.Country.sql */
PRINT 'Deploying: ChartMartControl.Country.sql'
GO
...
/* Deploying: ChartMartControl.SpotifyCountry.Populate.sql */
PRINT 'Deploying: ChartMartControl.SpotifyCountry.Populate.sql'
GO
...
/* Deploying: ChartMartControl.ObtainCoutries.sql */
PRINT 'Deploying: ChartMartControl.ObtainCoutries.sql'
GO
