...
USING 
	(VALUES
	  ...
	  --[EI],	[PETI],	[AI],	[IS],	[HMS],	[Name],										[Code],									[Description],													[Schema],				[Table],									[CreatedBy]							[CreatedDate]
		...
		(600,	NULL,	12,		1,		0,		N'DMAdjustmentReason',						N'DM_ADJUSTMENT_REASON',				N'Oracle ADJUSTMENT_REASON table',								N'DMOWN',				N'DM_ADJUSTMENT_REASON',					N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(601,	NULL,	12,		1,		0,		N'DMBroadcastRegion',							N'DM_BROADCAST_REGION',					N'Oracle BROADCAST_REGION table',								N'DMOWN',				N'DM_BROADCAST_REGION',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(602,	NULL,	12,		1,		0,		N'DMCae',										N'DM_CAE',								N'Oracle CAE table',											N'DMOWN',				N'DM_CAE',									N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(603,	NULL,	12,		1,		0,		N'DMCashingOutGroup',							N'DM_CASHING_OUT_GROUP',				N'Oracle CASHING_OUT_GROUP table',								N'DMOWN',				N'DM_CASHING_OUT_GROUP',					N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(604,	NULL,	12,		1,		0,		N'DMCurrency',								N'DM_CURRENCY',							N'Oracle CURRENCY table',										N'DMOWN',				N'DM_CURRENCY',								N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(605,	NULL,	12,		1,		1,		N'DMDigitalTransactions',						N'DM_DIGITAL_TRANSACTIONS',				N'Oracle DIGITAL_TRANSACTIONS table',							N'DMOWN',				N'DM_DIGITAL_TRANSACTIONS',					N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(606,	NULL,	12,		1,		0,		N'DMDistribution',							N'DM_DISTRIBUTION',						N'Oracle DISTRIBUTION table',									N'DMOWN',				N'DM_DISTRIBUTION',							N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(607,	NULL,	12,		1,		0,		N'DMInvoices',								N'DM_INVOICES',							N'Oracle INVOICES table',										N'DMOWN',				N'DM_INVOICES',								N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(608,	NULL,	12,		1,		0,		N'DMLicensingBodies',							N'DM_LICENSING_BODIES',					N'Oracle LICENSING_BODIES table',								N'DMOWN',				N'DM_LICENSING_BODIES',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(609,	NULL,	12,		1,		0,		N'DMMemberDistributionSumm',					N'DM_MEMBER_DISTRIBUTION_SUMM',			N'Oracle MEMBER_DISTRIBUTION_SUMM table',						N'DMOWN',				N'DM_MEMBER_DISTRIBUTION_SUMM',				N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(610,	NULL,	12,		1,		0,		N'DMMembershipType',							N'DM_MEMBERSHIP_TYPE',					N'Oracle MEMBERSHIP_TYPE table',								N'DMOWN',				N'DM_MEMBERSHIP_TYPE',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(611,	NULL,	12,		1,		0,		N'DMPerformance',								N'DM_PERFORMANCE',						N'Oracle PERFORMANCE table',									N'DMOWN',				N'DM_PERFORMANCE',							N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(612,	NULL,	12,		1,		0,		N'DMProductTypes',							N'DM_PRODUCT_TYPES',					N'Oracle PRODUCT_TYPES table',									N'DMOWN',				N'DM_PRODUCT_TYPES',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(613,	NULL,	12,		1,		0,		N'DMPsMembersInDist',							N'DM_PS_MEMBERS_IN_DIST',				N'Oracle PS_MEMBERS_IN_DIST table',								N'DMOWN',				N'DM_PS_MEMBERS_IN_DIST',					N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(614,	NULL,	12,		1,		0,		N'DMRepertoirePosting',						N'DM_REPERTOIRE_POSTING',				N'Oracle REPERTOIRE_POSTING table',								N'DMOWN',				N'DM_REPERTOIRE_POSTING',					N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(615,	NULL,	12,		1,		0,		N'DMRoyaltyLineTransfer',						N'DM_ROYALTY_LINE_TRANSFER',			N'Oracle ROYALTY_LINE_TRANSFER table',							N'DMOWN',				N'DM_ROYALTY_LINE_TRANSFER',				N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(616,	NULL,	12,		1,		1,		N'DMRoyaltyTransaction',						N'DM_ROYALTY_TRANSACTION',				N'Oracle ROYALTY_TRANSACTION table',							N'DMOWN',				N'DM_ROYALTY_TRANSACTION',					N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(617,	NULL,	12,		1,		0,		N'DMServiceTypes',							N'DM_SERVICE_TYPES',					N'Oracle SERVICE_TYPES table',									N'DMOWN',				N'DM_SERVICE_TYPES',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(618,	NULL,	12,		1,		0,		N'DMSociety',									N'DM_SOCIETY',							N'Oracle SOCIETY table',										N'DMOWN',				N'DM_SOCIETY',								N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(619,	NULL,	12,		1,		0,		N'DMUsageCategories',							N'DM_USAGE_CATEGORIES',					N'Oracle USAGE_CATEGORIES table',								N'DMOWN',				N'DM_USAGE_CATEGORIES',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(620,	NULL,	12,		1,		0,		N'DMUsageGroup',								N'DM_USAGE_GROUP',						N'Oracle USAGE_GROUP table',									N'DMOWN',				N'DM_USAGE_GROUP',							N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(621,	NULL,	12,		1,		0,		N'DMUsageGroupSumm',							N'DM_USAGE_GROUP_SUMM',					N'Oracle USAGE_GROUP_SUMM table',								N'DMOWN',				N'DM_USAGE_GROUP_SUMM',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(622,	NULL,	12,		1,		0,		N'DMUsageGroupType',							N'DM_USAGE_GROUP_TYPE',					N'Oracle USAGE_GROUP_TYPE table',								N'DMOWN',				N'DM_USAGE_GROUP_TYPE',						N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(623,	NULL,	12,		1,		0,		N'MEMCountry',									N'MEM_COUNTRY',							N'Oracle COUNTRY table',										N'MEMOWN',				N'MEM_COUNTRY',								N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),
		(624,	NULL,	12,		1,		0,		N'MEMMembership',								N'MEM_MEMBERSHIP',						N'Oracle MEMBERSHIP table',										N'MEMOWN',				N'MEM_MEMBERSHIP',							N'piotr.starczynski@prsformusic.com',  SYSDATETIME()),	
		...
		-- Publication Date (Under SAS Datafixes project)
		(1280,	-1,		8,		1,		0,		N'SASStatementEmailControl',			    N'sasstatementemailcontrol',	        N'SAS Statement Email Control table',							N'SAS',					N'SAS_STATEMENT_EMAIL_CONTROL',				N'chris.ellis@prsformusic.com',	    SYSDATETIME()),
		(1360,	NULL,	8,		0,		0,		N'DimDistribution',							N'DimDistribution',						N'SAS Dim Distribution',										N'Warehouse',			N'DimDistribution',							N'chris.ellis@prsformusic.com',	    SYSDATETIME()),
...
--Pre-Distribution Cashing Out
	  --[EI],	[PETI],	[AI],	[IS],	[HMS],	[Name],										[Code],									[Description],													[Schema],				[Table],									[CreatedBy]								[CreatedDate]

		(1101,	NULL,	12,		1,		0,		N'DMCashingOutHistory',						N'DM_CASHING_OUT_HISTORY',				N'Oracle CASHING_OUT_HISTORY table',							N'DMOWN',				N'DM_CASHING_OUT_HISTORY',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1102,	NULL,	12,		1,		0,		N'DMCopyCashDetails',						N'DM_COPY_CASH_DETAILS',				N'Oracle COPY_CASH_DETAILS table',								N'DMOWN',				N'DM_COPY_CASH_DETAILS',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1103,	NULL,	12,		1,		0,		N'DMUsageGroupCodaAccounts',				N'DM_USAGE_GROUP_CODA_ACCOUNTS',		N'Oracle USAGE_GROUP_CODA_ACCOUNTS table',						N'DMOWN',				N'DM_USAGE_GROUP_CODA_ACCOUNTS',			N'emma.stewart@prsformusic.com',		SYSDATETIME()),	
		(1104,	NULL,	12,		1,		0,		N'DMRepRequestHistPlist',					N'DM_REP_REQUEST_HIST_PLIST',			N'Oracle REP_REQUEST_HIST_PLIST table',							N'DMOWN',				N'DM_REP_REQUEST_HIST_PLIST',				N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1105,	NULL,	12,		1,		0,		N'DMCodaAccount',							N'DM_CODA_ACCOUNT',						N'Oracle CODA_ACCOUNT table',									N'DMOWN',				N'DM_CODA_ACCOUNT',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
 ...
 -- Online Migration -- REPTXN
		(1123,	NULL,	5,		0,		0,		N'FactInvoiceUsageText',				   N'dspFactInvoiceUsageText',			   N'Online Rep Fact Invoice Usage Text',							N'Fact',				N'InvoiceUsageText',					    N'vandana.bangera@prsformusic.com',		SYSDATETIME()),
 
 --Pre-Distribution
		(1124,	NULL,	12,		1,		0,		N'DMDistributionType',						N'DM_DISTRIBUTION_TYPE',				N'Oracle DISTRIBUTION_TYPE table',								N'DMOWN',				N'DM_DISTRIBUTION_TYPE',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1125,	NULL,	12,		1,		0,		N'DMDistributedWork',						N'DM_DISTRIBUTED_WORK',					N'Oracle DISTRIBUTED_WORK table',								N'DMOWN',				N'DM_DISTRIBUTED_WORK',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1126,	NULL,	12,		1,		0,		N'DMDigitalPerformances',					N'DM_DIGITAL_PERFORMANCES',				N'Oracle DIGITAL_PERFORMANCES table',							N'DMOWN',				N'DM_DIGITAL_PERFORMANCES',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
 ...
 -- CODA FDM - DimDate
		(1130,	-1,		4,		0,		0,		N'DimDate',								   N'fdmdimdate',						   N'Finance DataMart Coda Dim_Date',								N'CodaWarehouse',		N'DimDates',								N'vandana.bangera@prsformusic.com',		SYSDATETIME()),
		(1131,	NULL,	14,		1,		0,		N'stgTerritory',						   N'stgTerritory',				           N'stgTerritory From MDS To Stage DB',						   	N'IFR',		     	    N'stgTerritory',	       	            	N'senay.yilmaz@prsformusic.com',		SYSDATETIME()),
		(1132,	NULL,	14,		1,		0,		N'DimTerritory',		                   N'DimTerritory',	                       N'DimTerritory  To DWH',		    	                         	N'IFR',			    	N'DimTerritory',	      	             	N'senay.yilmaz@prsformusic.com',		SYSDATETIME()),
 ...
 -- CaaseQC
		...
		(1144,	NULL,	15,		1,		0,		N'TrnWorkLevel',						   N'CaseQCtrnWorkLevel',				   N'CaseQC Trn Work Level',						   				N'dbo',		     		N'WorkLevel',	       	            	    N'vandana.bangera@prsformusic.com',		SYSDATETIME()),
		(1145,	NULL,	15,		1,		0,		N'TrnProductionLevel',		               N'CaseQCtrnProductionLevel',			   N'CaseQC Trn Production Level',                        			N'dbo',					N'ProductionLevel',	      	             	N'vandana.bangera@prsformusic.com',		SYSDATETIME()),
 ...
 --Pre-Distribution
		(1150,	NULL,	12,		1,		0,		N'DMInvoiceLegalEarnerLin',					N'DM_INVOICE_LEGAL_EARNER_LIN',			N'Oracle DM_INVOICE_LEGAL_EARNER_LIN table',					N'DMOWN',				N'DM_INVOICE_LEGAL_EARNER_LIN',				N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1151,	NULL,	12,		1,		0,		N'DMInvoiceAud',						   N'DM_INVOICE_AUD',						N'Oracle INVOICE_AUD table',									N'DMOWN',				N'DM_INVOICE_AUD',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),

-- Pre- Distribution Data Store
		(1152,	NULL,	12,		0,		0,		N'AdjustmentReason',						N'AdjustmentReason',					N'Play to Pay AdjustmentReason table',							N'DmDataStore',			N'AdjustmentReason',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1153,	NULL,	12,		0,		0,		N'BroadcastRegion',							N'BroadcastRegion',						N'Play to Pay BroadcastRegion table',							N'DmDataStore',			N'BroadcastRegion',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1154,	NULL,	12,		0,		0,		N'Cae',										N'Cae',									N'Play to Pay Cae table',										N'DmDataStore',			N'Cae',										N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1155,	NULL,	12,		0,		0,		N'CashingOutGroup',							N'CashingOutGroup',						N'Play to Pay CashingOutGroup table',							N'DmDataStore',			N'CashingOutGroup',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1156,	NULL,	12,		0,		0,		N'Currency',								N'Currency',							N'Play to Pay Currency table',									N'DmDataStore',			N'Currency',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1157,	NULL,	12,		0,		0,		N'DigitalTransactions',						N'DigitalTransactions',					N'Play to Pay DigitalTransactions table',						N'DmDataStore',			N'DigitalTransactions',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1158,	NULL,	12,		0,		0,		N'Distribution',							N'Distribution',						N'Play to Pay Distribution table',								N'DmDataStore',			N'Distribution',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1159,	NULL,	12,		0,		0,		N'Invoices',								N'Invoices',							N'Play to Pay Invoices table',									N'DmDataStore',			N'Invoices',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1160,	NULL,	12,		0,		0,		N'LicensingBodies',							N'LicensingBodies',						N'Play to Pay LicensingBodies table',							N'DmDataStore',			N'LicensingBodies',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1161,	NULL,	12,		0,		0,		N'MemberDistributionSumm',					N'MemberDistributionSumm',				N'Play to Pay MemberDistributionSumm table',					N'DmDataStore',			N'MemberDistributionSumm',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1162,	NULL,	12,		0,		0,		N'MembershipType',							N'MembershipType',						N'Play to Pay MembershipType table',							N'DmDataStore',			N'MembershipType',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1163,	NULL,	12,		0,		0,		N'Performance',								N'Performance',							N'Play to Pay Performance table',								N'DmDataStore',			N'Performance',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1164,	NULL,	12,		0,		0,		N'ProductTypes',							N'ProductTypes',						N'Play to Pay ProductTypes table',								N'DmDataStore',			N'ProductTypes',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1165,	NULL,	12,		0,		0,		N'PsMembersInDist',							N'PsMembersInDist',						N'Play to Pay PsMembersInDist table',							N'DmDataStore',			N'PsMembersInDist',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1166,	NULL,	12,		0,		0,		N'RepertoirePosting',						N'RepertoirePosting',					N'Play to Pay RepertoirePosting table',							N'DmDataStore',			N'RepertoirePosting',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1167,	NULL,	12,		0,		0,		N'RoyaltyLineTransfer',						N'RoyaltyLineTransfer',					N'Play to Pay RoyaltyLineTransfer table',						N'DmDataStore',			N'RoyaltyLineTransfer',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1168,	NULL,	12,		0,		0,		N'RoyaltyTransaction',						N'RoyaltyTransaction',					N'Play to Pay RoyaltyTransaction table',						N'DmDataStore',			N'RoyaltyTransaction',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1169,	NULL,	12,		0,		0,		N'ServiceTypes',							N'ServiceTypes',						N'Play to Pay ServiceTypes table',								N'DmDataStore',			N'ServiceTypes',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1170,	NULL,	12,		0,		0,		N'Society',									N'Society',								N'Play to Pay Society table',									N'DmDataStore',			N'Society',									N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1171,	NULL,	12,		0,		0,		N'UsageCategories',							N'UsageCategories',						N'Play to Pay UsageCategories table',							N'DmDataStore',			N'UsageCategories',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1172,	NULL,	12,		0,		0,		N'UsageGroup',								N'UsageGroup',							N'Play to Pay UsageGroup table',								N'DmDataStore',			N'UsageGroup',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1173,	NULL,	12,		0,		0,		N'UsageGroupSumm',							N'UsageGroupSumm',						N'Play to Pay UsageGroupSumm table',							N'DmDataStore',			N'UsageGroupSumm',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1174,	NULL,	12,		0,		0,		N'UsageGroupType',							N'UsageGroupType',						N'Play to Pay UsageGroupType table',							N'DmDataStore',			N'UsageGroupType',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1175,	NULL,	12,		0,		0,		N'Country',									N'Country',								N'Play to Pay Country table',									N'DmDataStore',			N'Country',									N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1176,	NULL,	12,		0,		0,		N'Membership',								N'Membership',							N'Play to Pay Membership table',								N'DmDataStore',			N'Membership',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1177,	NULL,	12,		0,		0,		N'CashingOutHistory',						N'CashingOutHistory',					N'Play to Pay CashingOutHistory table',							N'DmDataStore',			N'CashingOutHistory',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1178,	NULL,	12,		0,		0,		N'CopyCashDetails',							N'CopyCashDetails',						N'Play to Pay CopyCashDetails table',							N'DmDataStore',			N'CopyCashDetails',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1179,	NULL,	12,		0,		0,		N'UsageGroupCodaAccounts',					N'UsageGroupCodaAccounts',				N'Play to Pay UsageGroupCodaAccounts table',					N'DmDataStore',			N'UsageGroupCodaAccounts',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1180,	NULL,	12,		0,		0,		N'RepRequestHistPlist',						N'RepRequestHistPlist',					N'Play to Pay RepRequestHistPlist table',						N'DmDataStore',			N'RepRequestHistPlist',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1181,	NULL,	12,		0,		0,		N'CodaAccount',								N'CodaAccount',							N'Play to Pay CodaAccount table',								N'DmDataStore',			N'CodaAccount',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1182,	NULL,	12,		0,		0,		N'DistributionType',						N'DistributionType',					N'Play to Pay DistributionType table',							N'DmDataStore',			N'DistributionType',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1183,	NULL,	12,		0,		0,		N'DistributedWork',							N'DistributedWork',						N'Play to Pay DistributedWork table',							N'DmDataStore',			N'DistributedWork',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1184,	NULL,	12,		0,		0,		N'DigitalPerformances',						N'DigitalPerformances',					N'Play to Pay DigitalPerformances table',						N'DmDataStore',			N'DigitalPerformances',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1185,	NULL,	12,		0,		0,		N'InvoiceLegalEarnerLin',					N'InvoiceLegalEarnerLin',				N'Play to Pay InvoiceLegalEarnerLines table',					N'DmDataStore',			N'InvoiceLegalEarnerLines',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1186,	NULL,	12,		0,		0,		N'InvoiceAud',								N'InvoiceAud',							N'Play to Pay InvoiceAud table',								N'DmDataStore',			N'InvoiceAud',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1187,	NULL,	12,		1,		1,		N'DMDeductions',							N'DM_DEDUCTIONS',						N'Oracle DM_DEDUCTIONS table',									N'DMOWN',				N'DM_DEDUCTIONS',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1188,	NULL,	12,		0,		0,		N'Deductions',								N'Deductions',							N'Play to Pay Deductions table',								N'DmDataStore',			N'Deductions',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1189,	NULL,	12,		1,		0,		N'DMDeductionTypes',						N'DM_DEDUCTION_TYPES',					N'Oracle DM_DEDUCTION_TYPES table',								N'DMOWN',				N'DM_DEDUCTION_TYPES',						N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1190,	NULL,	12,		0,		0,		N'DeductionTypes',							N'DeductionTypes',						N'Play to Pay DeductionTypes table',							N'DmDataStore',			N'DeductionTypes',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1191,	NULL,	12,		1,		0,		N'DMInvoicesAud',							N'DM_INVOICES_AUD',						N'Oracle DM_INVOICES_AUD table',								N'DMOWN',				N'DM_INVOICES_AUD',							N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1192,	NULL,	12,		0,		0,		N'InvoicesAud',								N'InvoicesAud',							N'Play to Pay InvoicesAud table',								N'DmDataStore',			N'InvoicesAud',								N'emma.stewart@prsformusic.com',		SYSDATETIME()),

		(1193,	NULL,	14,		0,		0,		N'stgThreshold',							N'stgThreshold',						N'stgThreshold from MDS to Stage DB',							N'IFR',				    N'stgThreshold',							N'senay.yilmaz@prsformusic.com',		SYSDATETIME()),
		(1194,	NULL,	14,		0,		0,		N'DimThreshold',							N'DimThreshold',						N'DimThreshold to DWH',					             			N'IFR',		        	N'DimThreshold',						    N'senay.yilmaz@prsformusic.com',		SYSDATETIME()),

		(1195,	NULL,	12,		1,		0,		N'P2PDmExtractControl',						N'DM_P2P_DM_EXTRACT_CONTROL',			N'Oracle DM_P2P_DM_EXTRACT_CONTROL table',						N'DMOWN',				N'DM_P2P_DM_EXTRACT_CONTROL',				N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		(1196,	NULL,	12,		1,		0,		N'DMDeletedInvoices',						N'DM_DELETED_INVOICES',					N'Oracle DM_DELETED_INVOICES view',								N'DPOWN',				N'DM_DELETED_INVOICES',						N'vandana.bangera@prsformusic.com',		SYSDATETIME()),

		(1197,	NULL,	12,		1,		0,		N'DMDeletedRepPosting',						N'DM_DELETED_REP_POSTING',				N'Oracle DM_DELETED_REP_POSTING view',							N'DPOWN',				N'DM_DELETED_REP_POSTING',					N'vandana.bangera@prsformusic.com',		SYSDATETIME()),
		
		--(1198,	NULL,	12,		0,		0,		N'InvoiceLegalEarnerLin',					N'InvoiceLegalEarnerLin',				N'Play to Pay InvoiceLegalEarnerLines table',					N'PipelineTransform',	N'InvoiceLegalEarnerLines',					N'emma.stewart@prsformusic.com',		SYSDATETIME()),
		

		(1199,	NULL,	12,		0,		0,		N'TempInvoiceLegalEarnerLinExisting',		N'dminvoicelegalearnerlinexisting',		N'DM Invoice_Legal_Earner_Lines table',							N'PipelineTransform',	N'TempInvoiceLegalEarnerLinExisting',		N'vandana.bangera@prsformusic.com',	SYSDATETIME()),
		(1200,	NULL,	12,		0,		0,		N'TempInvoiceLegalEarnerLinNew',			N'dminvoicelegalearnerlinnew',			N'DM Invoice_Legal_Earner_Lines table',							N'PipelineTransform',	N'TempInvoiceLegalEarnerLinNew',			N'vandana.bangera@prsformusic.com',	SYSDATETIME()),
		(1201,	NULL,	12,		0,		0,		N'TempInvoiceLegalEarnerLinChanged',		N'dminvoicelegalearnerlinchanged',		N'DM Invoice_Legal_Earner_Lines table',							N'PipelineTransform',	N'TempInvoiceLegalEarnerLinChanged',		N'vandana.bangera@prsformusic.com',	SYSDATETIME()),			
																																																								
		(1203,	NULL,	12,		0,		0,		N'TempDigitalTransactionsExisting',			N'dmdigitaltransactionsexisting',		N'DM Digital_Transactions table',								N'PipelineTransform',	N'TempDigitalTransactionsExisting',			N'vandana.bangera@prsformusic.com',	SYSDATETIME()),
		(1204,	NULL,	12,		0,		0,		N'TempDigitalTransactionsNew',				N'dmdigitaltransactionsnew',			N'DM Digital_Transactions table',								N'PipelineTransform',	N'TempDigitalTransactionsNew',				N'vandana.bangera@prsformusic.com',	SYSDATETIME()),
		(1205,	NULL,	12,		0,		0,		N'TempDigitalTransactionsChanged',			N'dmdigitaltransactionschanged',		N'DM Digital_Transactions table',								N'PipelineTransform',	N'TempDigitalTransactionsChanged',			N'vandana.bangera@prsformusic.com',	SYSDATETIME()),
		
		(1206,	NULL,	12,		0,		0,		N'TempDeductionsExisting',					N'dmdeductionsexisting',				N'DM Deductions table',											N'PipelineTransform',	N'TempDeductionsExisting',					N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1207,	NULL,	12,		0,		0,		N'TempDeductionsNew',						N'dmdeductionssnew',					N'DM Deductions table',											N'PipelineTransform',	N'TempDeductionsNew',						N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1208,	NULL,	12,		0,		0,		N'TempDeductionsChanged',					N'dmdeductionschanged',					N'DM Deductions table',											N'PipelineTransform',	N'TempDeductionsChanged',					N'emma.stewart@prsformusic.com',	SYSDATETIME()),

		(1209,	NULL,	12,		0,		0,		N'TempDigitalPerformancesExisting',			N'dmdigitalperformancesexisting',		N'DM Digital_Performances table',								N'PipelineTransform',	N'TempDigitalPerformancesExisting',			N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1210,	NULL,	12,		0,		0,		N'TempDigitalPerformancesNew',				N'dmdigitalperformancesnew',			N'DM Digital_Performances table',								N'PipelineTransform',	N'TempDigitalPerformancesNew',				N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1211,	NULL,	12,		0,		0,		N'TempDigitalPerformancesChanged',			N'dmdigitalperformanceschanged',		N'DM Digital_Performances table',								N'PipelineTransform',	N'TempDigitalPerformancesChanged',			N'emma.stewart@prsformusic.com',	SYSDATETIME()),

		(1212,	NULL,	12,		0,		0,		N'TempPerformanceExisting',					N'dmperformanceexisting',				N'DM Performance table',										N'PipelineTransform',	N'TempPerformanceExisting',					N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1213,	NULL,	12,		0,		0,		N'TempPerformanceNew',						N'dmperformancenew',					N'DM Performance table',										N'PipelineTransform',	N'TempPerformanceNew',						N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1214,	NULL,	12,		0,		0,		N'TempPerformanceChanged',					N'dmperformancechanged',				N'DM Performance table',										N'PipelineTransform',	N'TempPerformanceChanged',					N'emma.stewart@prsformusic.com',	SYSDATETIME()),

		(1215,	NULL,	12,		0,		0,		N'TempRoyaltyTransactionExisting',			N'dmroyaltytransactionexisting',		N'DM Royalty_Transaction table',								N'PipelineTransform',	N'TempRoyaltyTransactionExisting',			N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1216,	NULL,	12,		0,		0,		N'TempRoyaltyTransactionNew',				N'dmroyaltytransactionnew',				N'DM Royalty_Transaction table',								N'PipelineTransform',	N'TempRoyaltyTransactionNew',				N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		(1217,	NULL,	12,		0,		0,		N'TempRoyaltyTransactionChanged',			N'dmroyaltytransactionchanged',			N'DM Royalty_Transaction table',								N'PipelineTransform',	N'TempRoyaltyTransactionChanged',			N'emma.stewart@prsformusic.com',	SYSDATETIME()),
		...
		(1400,	-1,		22,		1,		0,		N'CustomObjects1',							N'customobjects1',	     				N'CustomObjects1 table Licenses',								N'Stage',				N'CustomObjects1',							N'emma.williams@prsformusic.com',	SYSDATETIME()),
		(1401,	-1,		22,		1,		0,		N'CustomObjects4',							N'customobjects4',	     				N'CustomObjects4 table Fee',									N'Stage',				N'CustomObjects4',							N'emma.williams@prsformusic.com',	SYSDATETIME()),
		(1402,	-1,		22,		1,		0,		N'CustomObjects5',							N'customobjects5',	     				N'CustomObjects5 table Channel IPC sub',						N'Stage',				N'CustomObjects5',							N'emma.williams@prsformusic.com',	SYSDATETIME()),
		(1403,	-1,		22,		1,		0,		N'CustomObjects6',							N'customobjects6',	     				N'CustomObjects6 table Channel country',						N'Stage',				N'CustomObjects6',							N'emma.williams@prsformusic.com',	SYSDATETIME()),	
		(1404,	-1,		22,		1,		0,		N'Accounts',								N'accounts',	     					N'Accounts table',												N'Stage',				N'Accounts',								N'emma.williams@prsformusic.com',	SYSDATETIME()),

		(1405,	-1,		22,		1,		0,		N'Clean_Fee',								N'fee',	     							N'Fee',															N'Clean',				N'Fee',										N'emma.williams@prsformusic.com',	SYSDATETIME()),
		(1406,	-1,		22,		1,		0,		N'Clean_ChannelIPCSub',						N'channelIPCSub',	     				N'Channel IPC sub',												N'Clean',				N'ChannelIPCSub',							N'emma.williams@prsformusic.com',	SYSDATETIME()),
		(1407,	-1,		22,		1,		0,		N'Clean_ChannelCountry',					N'channelcountry',	     				N'Channel country',												N'Clean',				N'ChannelCountry',							N'emma.williams@prsformusic.com',	SYSDATETIME()),
		(1408,	-1,		22,		1,		0,		N'Clean_Licence',							N'licence',	     						N'License',														N'Clean',				N'Licence',									N'emma.williams@prsformusic.com',	SYSDATETIME()),
		--(1409,	-1,		22,		1,		0,		N'Clean_Accounts',							N'accounts',	     					N'Accounts',													N'Clean',				N'Accounts',								N'emma.williams@prsformusic.com',	SYSDATETIME()),
		...
		(1306,	-1,		20,		1,		0,		N'MasterUDC',								N'masterudc',							N'Master UDC Data',												N'FPV',					N'MasterUDC',					N'tim.firmin@prsformusic.com',	SYSDATETIME()),
		(1307,	-1,		20,		1,		0,		N'LicenceGroup',							N'masterlicencegroup',					N'Master Licence Group',										N'FPV',					N'LicenceGroup',					N'tim.firmin@prsformusic.com',	SYSDATETIME()),
		...
		--Jack Stuff
		(1700,	NULL,	15,		1,		0,		N'LivePerformanceLevel',				    N'CaseQCstgLivePerformanceLevel',	    N'CaseQC Stg LivePerformance Level',							N'CaseQC',		        N'LivePerformanceLevel',				    N'jack.fenner@prsformusic.com',  SYSDATETIME())
