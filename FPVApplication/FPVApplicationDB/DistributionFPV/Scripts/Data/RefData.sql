...
APPLICATION REQUESTS ARE CALLS FROM AN APPLICATION TO THE DATABASE
REQUESTS ARE IDENTIFIED BY REQUEST CODE
THIS TABLE DEFINES A PROCEDURE THAT WILL BE ACTIONED TO SERVICE THE REQUEST
****************************************************************************/
...
/****************************************************************************
DISTRIBUTION GROUPS - maintained by SSIS
****************************************************************************/
--MERGE [FPV].[DistributionGroup] T
--USING (VALUES('ILR',1)) S ([DistributionGroupCode],[Enabled])
--ON T.[DistributionGroupCode]=S.[DistributionGroupCode]

--WHEN NOT MATCHED BY TARGET THEN 
--INSERT ([DistributionGroupCode],[Enabled])
--VALUES (S.[DistributionGroupCode],[Enabled])
...
USING (
		VALUES 
			...
			,(3,'LicenceGroup','Sync from MDS','LicenceGroupToFPV','uspMergeLicenceGroup')
