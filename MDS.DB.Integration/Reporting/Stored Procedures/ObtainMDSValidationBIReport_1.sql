...
CREATE PROCEDURE  [Reporting].[ObtainMDSValidationBIReport] 
@LoadId bigint,
@RuleType varchar(50) 
AS
BEGIN 
...
(		SELECT * 
		...
		WHERE  LoadId = @LoadId  and NotificationTemplate like '%MDS Validation BI%' And (RuleType = @RuleType OR @RuleType  = '<All>')
