...
CREATE PROCEDURE  [Reporting].[ObtainMDSValidationSDMReport] 
@LoadId bigint,
@RuleType varchar(50)
AS
BEGIN 
...
(		SELECT * 
		...
		WHERE  LoadId = @LoadId  and NotificationTemplate like '%MDS Validation SDM%' And (RuleType = @RuleType OR @RuleType  = '<All>')
