...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'001 Process Global Process', 
		...
		@command=N'/ISSERVER "\"\SSISDB\TM1FDM\H2PlanningTM1\H2PlanningTM1.GlobalProcess.dtsx\"" /SERVER "\"AZI-MS-SIS-U001,50501\"" /X86 /ENVREFERENCE 103 /Par "\"intSetRunMode(Int32)\"";0 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
