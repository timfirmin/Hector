...
DECLARE @strBISystemADOConnectionString SQL_VARIANT = N'Data Source=AZP-MS-SQL-P001.database.windows.net;Initial Catalog=BISystem;Connect Timeout=60;ConnectRetryCount=3;ConnectRetryInterval=20;Authentication="Active Directory Integrated"';
DECLARE @strBITDataMartDBName SQL_VARIANT = N'FinanceDataMart'
DECLARE @strBITStageDBName SQL_VARIANT = N'FinanceStage'
DECLARE @strFinanceDataMartADONETConnectionString SQL_VARIANT =  N'Data Source=AZI-MS-SQL-P001,50501;Initial Catalog=FinanceDataMart;Integrated Security=True;'
DECLARE @strFinanceStageADONETConnectionString SQL_VARIANT = N'Data Source=AZI-MS-SQL-P001,50501;Initial Catalog=FinanceStage;Integrated Security=True;'
DECLARE @strHectorADONETConnectionString SQL_VARIANT = N'Data Source=AZI-MS-SQL-P001,50501;Initial Catalog=Hector2;Integrated Security=True;'
DECLARE @strMailProfileName SQL_VARIANT = N'AZI-MS-SQL-P001 SQL Database Mail'
DECLARE @strSISDatabaseMail SQL_VARIANT = N'AZI-MS-SIS-P001 SQL Database Mail'
DECLARE @strMailRecipientList SQL_VARIANT = N'support-bi-apps@prsformusic.com'
DECLARE @strMailRecipientListSupport SQL_VARIANT = N'support-bi-apps@prsformusic.com'
DECLARE @strMDSADOConnectionString SQL_VARIANT = N'Data Source=AZI-MS-SQL-P001,50501;Initial Catalog=MDS;Integrated Security=True;'
DECLARE @strMDSConnectionString SQL_VARIANT = N'Data Source=AZI-MS-SQL-P001,50501;Initial Catalog=mds;Provider=SQLOLEDB;Integrated Security=SSPI;Auto Translate=false;'
DECLARE @strMDSUserName SQL_VARIANT = N'PRS\ServiceDevSQLU001MDS'
DECLARE @strSourceFileFolder SQL_VARIANT = N'\\ONP-MS-FSS-DV01\Data\Proj\Hector2\Prod\'
DECLARE @strSSISConfigurationConnectionString SQL_VARIANT = N'Data Source=AZI-MS-SIS-P001,50501;Initial Catalog=SSISConfiguration;Integrated Security=True;'
DECLARE @strSSISDBConnectionString SQL_VARIANT = N'Data Source=AZI-MS-SIS-P001,50501;Initial Catalog=SSISDB;Integrated Security=True;'
DECLARE @strSSISDBProjectFolder SQL_VARIANT = N'TM1FDM'
DECLARE @strSSISProjectEnvironment SQL_VARIANT = N'Prod'
DECLARE @strFPVDestinationSchemaTable SQL_VARIANT = N'Staging.BaseRevenueTM1'

-- environment
DECLARE @environmentName NVARCHAR(255) = N'Prod';
...
EXEC [SSISDB].[catalog].[create_environment_variable] 
	@variable_name=N'strHectorADONETConnectionString', 
	@sensitive=False, 
	@description=N'', 
	@environment_name=@environmentName, 
	@folder_name=@folderName, 
